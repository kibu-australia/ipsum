...
{return (function() { 
var G__6036__delegate = function (args){return cljs.core.apply.call(null,v,args);
};
...
{return cljs.core.reduce_kv.call(null,(function (res,k,v){var G__6039 = res;(G__6039[reagent.impl.template.cached_prop_name.call(null,k)] = reagent.impl.template.to_js_val.call(null,v));
return G__6039;
}),{},val);
} else
...
reagent.impl.template.set_id_class = (function set_id_class(props,p__6040){var vec__6042 = p__6040;var id = cljs.core.nth.call(null,vec__6042,0,null);var class$ = cljs.core.nth.call(null,vec__6042,1,null);var pid = (props["id"]);(props["id"] = ((!((pid == null)))?pid:id));
if((class$ == null))
{return null;
} else
...
{if(new cljs.core.Keyword(null,"else","else",1017020587))
{var objprops = cljs.core.reduce_kv.call(null,(function (o,k,v){var pname_6043 = reagent.impl.template.cached_prop_name.call(null,k);if(!((pname_6043 === "key")))
{(o[pname_6043] = reagent.impl.template.convert_prop_value.call(null,v));
} else
{}
return o;
...
var G__6046 = jsprops;(G__6046["defaultValue"] = value);
(G__6046["value"] = null);
(G__6046["onChange"] = (function (p1__6044_SHARP_){return reagent.impl.template.input_handle_change.call(null,this$,on_change,p1__6044_SHARP_);
}));
return G__6046;
}
});
...
reagent.impl.template.add_input_methods = (function add_input_methods(spec){var G__6048 = spec;(G__6048["componentDidUpdate"] = (function (){var C = this;return reagent.impl.template.input_did_update.call(null,C);
}));
(G__6048["componentWillUnmount"] = (function (){var C = this;return reagent.impl.batching.dispose.call(null,C);
}));
return G__6048;
});
...
return (function (p1__6049_SHARP_,p2__6050_SHARP_){var C = this;return reagent.impl.template.wrapped_should_update.call(null,C,p1__6049_SHARP_,p2__6050_SHARP_);
...
reagent.impl.template.parse_tag = (function parse_tag(hiccup_tag){var vec__6052 = cljs.core.next.call(null,cljs.core.re_matches.call(null,reagent.impl.template.re_tag,cljs.core.name.call(null,hiccup_tag)));var tag = cljs.core.nth.call(null,vec__6052,0,null);var id = cljs.core.nth.call(null,vec__6052,1,null);var class$ = cljs.core.nth.call(null,vec__6052,2,null);var comp = (reagent.impl.template.DOM[tag]);var class_SINGLEQUOTE_ = (cljs.core.truth_(class$)?clojure.string.replace.call(null,class$,/\./," "):null);if(cljs.core.truth_(comp))
{} else
...
reagent.impl.template.get_wrapper = (function get_wrapper(tag){var vec__6054 = reagent.impl.template.parse_tag.call(null,tag);var comp = cljs.core.nth.call(null,vec__6054,0,null);var id_class = cljs.core.nth.call(null,vec__6054,1,null);return reagent.impl.template.wrap_component.call(null,comp,id_class,[cljs.core.str(tag)].join(''));
});
...
var c = reagent.impl.template.as_class.call(null,cljs.core.nth.call(null,v,0));var jsprops = (function (){var obj6058 = {};(obj6058[reagent.impl.util.cljs_argv] = v);
(obj6058[reagent.impl.util.cljs_level] = level);
return obj6058;
})();var k_6059 = reagent.impl.template.get_key.call(null,cljs.core.meta.call(null,v));var k_SINGLEQUOTE__6060 = (((k_6059 == null))?reagent.impl.template.get_key.call(null,cljs.core.nth.call(null,v,1,null)):k_6059);if((k_SINGLEQUOTE__6060 == null))
{} else
{(jsprops["key"] = k_SINGLEQUOTE__6060);
}
...
reagent.impl.template.expand_seq = (function expand_seq(s,level){var a = cljs.core.into_array.call(null,s);var level_SINGLEQUOTE_ = (level + 1);var n__4250__auto___6061 = a.length;var i_6062 = 0;while(true){
if((i_6062 < n__4250__auto___6061))
{(a[i_6062] = reagent.impl.template.as_component.call(null,(a[i_6062]),level_SINGLEQUOTE_));
{
...
reagent.impl.template.convert_args = (function convert_args(argv,first_child,level){var a = cljs.core.into_array.call(null,argv);var n__4250__auto___6064 = a.length;var i_6065 = 0;while(true){
if((i_6065 < n__4250__auto___6064))
{if((i_6065 >= first_child))
{(a[i_6065] = reagent.impl.template.as_component.call(null,(a[i_6065]),level));
} else
{}
{
