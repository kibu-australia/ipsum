...
{{
var G__5992 = cljs.core.pop.call(null,v__$1);
v__$1 = G__5992;
continue;
}
} else
...
{var pred__5996 = cljs.core._EQ_;var expr__5997 = limit;if(cljs.core.truth_(pred__5996.call(null,1,expr__5997)))
{return (new cljs.core.PersistentVector(null,1,5,cljs.core.PersistentVector.EMPTY_NODE,[s],null));
} else
{if(cljs.core.truth_(pred__5996.call(null,2,expr__5997)))
...
var G__5999 = s__$1.substring((index + cljs.core.count.call(null,m)));
var G__6000 = (limit__$1 - 1);
var G__6001 = cljs.core.conj.call(null,parts,s__$1.substring(0,index));
s__$1 = G__5999;
limit__$1 = G__6000;
parts = G__6001;
continue;
...
{var ch = s.charAt(index);var temp__4090__auto___6003 = cljs.core.get.call(null,cmap,ch);if(cljs.core.truth_(temp__4090__auto___6003))
{var replacement_6004 = temp__4090__auto___6003;buffer.append([cljs.core.str(replacement_6004)].join(''));
} else
{buffer.append(ch);
}
{
